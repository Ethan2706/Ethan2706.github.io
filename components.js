...
(function () {
  ...
  Screens.home = () => {
    ...
    return `
      ...
      <section class="card glow rise mt-16" style="padding:18px;overflow:hidden">
        ...
        <p class="muted mt-8" style="font-size:14px;line-height:1.5">A peer-to-peer clothing swap for people in your community. No money, no waste, just clothes finding their next chapter.</p>
  ...
  Screens.about = () => `
    ...
    <div class="card" style="padding:16px">
      <p style="font-size:15px;line-height:1.55">Fast fashion's culture of overproduction and disposable consumption normalizes waste worldwide. <b style="font-family:var(--serif);font-size:18px">Re:Wear</b> replaces buying new with local reuse, a peer-to-peer swap built for everyday people, where no money changes hands and clothes stay in circulation.</p>
    </div>

    <div class="section-h"><h3>How Re:Wear helps</h3></div>
    <div class="card pill-list" style="padding:16px">
      <div class="fact"><div class="fi">①</div><div class="fb"><b>Addresses real needs.</b> People get a free, low-pressure way to refresh their wardrobe without funding overproduction, meeting both budget and values.</div></div>
      <div class="divider"></div>
